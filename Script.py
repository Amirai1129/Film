...
👉 آیا نام سریال/فیلم را به درستی وارد کرده اید؟"""
    ...
    EARN_TXT = """<b>🍿 آموزش استفاده از ربات فیلم و سریال فیلمیا

1- در گروه زیر عضو شوید
https://t.me/filmgirgp
2- جهت جست و جوی فیلم در گروه نام فیلم به همراه سال ساخت را به صورت انگلیسی ارسال کنید
برای مثال :
The Nun 2018
